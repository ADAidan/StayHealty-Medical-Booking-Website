                ...
                <div className="signup-form">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <input type="tel" name="phone" id="phone" required className={`${phoneError ? 'form-error' : 'form-control form-error'}`} placeholder="Enter your phone number" aria-describedby="helpId" value={phone} onChange={(e) => setPhone(e.target.value)} />
                            {phoneError && <p className="error-message">Phone number must be 10 or fewer digits.</p>}
                        </div>
                        <div className="form-group">
